...
기간 | pocco | reggie
--------|--------|--------
2024.10.24 ~ 10.28 | • 기본 UI 구조 설정 (Expo) | • 프로젝트 초기 환경 구성 (Expo)
2024.10.29 ~ 11.08 | • 홀드 분석 시스템 구현<br>• 게시글/댓글 시스템 기초<br>• UI/UX 기본 틀 구현<br>• API 기본 설계 | • 인증 시스템 구현
2024.11.11 ~ 11.21 | • 게시글 시스템 고도화<br>• 댓글 시스템 완성 | • 활동기록 시스템 구현
2024.11.25 ~ 12.01 | • 게시글/댓글 UI 완성<br>• 이미지 첨부 기능<br> • Vite + React + TS 마이그레이션<br>• 컴포넌트 리팩토링<br>• 인증/보안 시스템 구현 | • Web 환경 설정 지원
2024.12.02 ~ 12.24 | • 커뮤니티 시스템 고도화<br>• 팔로잉 기능 연동<br>• 프로필/타임라인 기능 완성<br>• 파일 처리 시스템 구현<br>• 최종 버그 수정 | • 추천/타임라인 시스템 구현<br>• 사용자 관계 시스템 구현
